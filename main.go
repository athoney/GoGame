...
func init() {
	gopher, _, err = ebitenutil.NewImageFromFile("./images/goSprites.png")
	background, _, err = ebitenutil.NewImageFromFile("./images/background.png")
	cactusPic, _, err = ebitenutil.NewImageFromFile("./images/cactus.png")
	blackBar, _, err = ebitenutil.NewImageFromFile("./images/black.png")
	flowerPic, _, err = ebitenutil.NewImageFromFile("./images/bobbingFlower.png")
	caps, _, err = ebitenutil.NewImageFromFile("./images/CapsHat.png")
	num, _, err = ebitenutil.NewImageFromFile("./images/numberWand.png")
	nonAlphaNum, _, err = ebitenutil.NewImageFromFile("./images/NonAlphaNum.png")
...
func main() {
	...
	ebiten.SetWindowTitle("Gopher Tough Passwords")
...
func checkPass(pass string) (string, string, string) {
	...
	result := hscan.GuessSingle(hex.EncodeToString(hash[:]), "./wordlists/wordlist2.txt")
